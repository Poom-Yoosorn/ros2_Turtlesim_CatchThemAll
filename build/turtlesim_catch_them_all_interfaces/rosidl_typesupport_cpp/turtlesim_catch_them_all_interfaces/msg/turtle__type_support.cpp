...
static const _Turtle_type_support_symbol_names_t _Turtle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_catch_them_all_interfaces, msg, Turtle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_catch_them_all_interfaces, msg, Turtle)),
  }
};
...
{
  return &::turtlesim_catch_them_all_interfaces::msg::rosidl_typesupport_cpp::Turtle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_catch_them_all_interfaces, msg, Turtle)() {
  return get_message_type_support_handle<turtlesim_catch_them_all_interfaces::msg::Turtle>();
}
